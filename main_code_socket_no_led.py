...
additional_frame_size = (duration * frame_rate) + (70)
...
# Initial: Randomly selected | CHANGE BACKGROUND OF THE SCREEN HERE 
background_white = False

# Dimensions: Size of the Animation Screen (Width, Height)  
                    ...
                    if recording:
                        ...
                        if frame_counter - .5 >= additional_frame_size:
                            ...
                            for idx, frame in enumerate(combined_frames_0):
                                cv2.imwrite(os.path.join(folder_name_0, f'frame_{idx:04d}_0.bmp'), frame)
                            for idx, frame in enumerate(combined_frames_1):
                                cv2.imwrite(os.path.join(folder_name_1, f'frame_{idx:04d}_1.bmp'), frame)
                            print("Images Saved!")
